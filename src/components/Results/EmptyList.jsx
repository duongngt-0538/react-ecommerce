...
const EmptyList = () => {
  ...
  return (
    <div className="hits-empty-state">
      ...
      <p className="hits-empty-state-description">Try to reset your applied filters.</p>
      <div className="ais-ClearRefinements">
        <button className="ais-ClearRefinements-button" type="button" onClick={handleClearFilters}>
